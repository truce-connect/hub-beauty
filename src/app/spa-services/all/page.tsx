...
const AllSpaServicesPage = () => {
  ...
  const allServices = [
    // Facial Services
    {
      ...
      description: 'A gentle cleansing facial that includes exfoliation, extraction, and a hydrating mask to rejuvenate your skin.',
      duration: '60 minutes',
      price: '£90',
      image: '/spa-images/facial1.jpg',
      category: 'Facial',
      categoryLink: '/spa-services/facial-spa'
    },
    {
      id: 2,
      title: 'Anti-Aging Facial',
      description: 'Targeted treatment to reduce fine lines and wrinkles while promoting collagen production for firmer, younger-looking skin.',
      duration: '75 minutes',
      price: '£120',
    ...
    },
    {
      ...
      description: 'Deeply moisturizing treatment that replenishes dry skin with essential nutrients and hydration.',
      duration: '60 minutes',
      price: '£100',
    ...
    // Intimate Services
    {
      ...
      category: 'Intimate',
      categoryLink: '/spa-services/intimate-spa'
    },
    {
      id: 8,
      title: 'Bikini Waxing',
...
export default AllSpaServicesPage;
