  ...
  return (
    <div className="flex items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-md w-full mx-auto p-6 bg-gray-800/50 backdrop-blur-sm rounded-lg shadow-lg border border-amber-500/10"
      >
        {error && (
          <motion.div
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input 
                ...
                required 
                className="w-full px-4 py-2 bg-gray-800 border border-amber-500/20 rounded-lg text-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 placeholder-amber-500/50"
